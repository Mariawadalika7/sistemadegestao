<div>
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-4" href="index.html">Gestão Eléctrica</a>
            <!-- Sidebar Toggle-->
            ...
            <div class=" d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
             ...
             <div class='d-flex col-md-2 justify-content-end '>
                <span class='text-white text-uppercase'>{{$user ? $user->fullname : ''}}</span>
                </div>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Painel do Funcionário</h1>
