            ...
            <div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
              ...
              <div class="dropdown-list-content dropdown-list-message">
                <a href="#" class="dropdown-item"> <span class="dropdown-item-avatar
                    ...
                    <img alt="image" src="{{ asset('customer/img/users/user-5.png') }}" class="rounded-circle">
                  </span> <span class="dropdown-item-desc"> <span class="message-user">Jacob
                      Ryan</span> <span class="time messege-text">Your payment invoice is
                      generated.</span> <span class="time">12 Min Ago</span>
                  </span>
                </a> <a href="#" class="dropdown-item"> <span class="dropdown-item-avatar text-white">
                    <img alt="image" src="{{ asset('customer/img/users/user-4.png') }}" class="rounded-circle">
                    ...
                    <img alt="image" src="{{ asset('customer/img/users/user-3.png') }}" class="rounded-circle">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="">
              <a href="#" class="menu-toggle nav-link has-dropdown">
                <i data-feather="briefcase"></i><span>Pagamentos</span></a>   
            </li>         
                    ...
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15 text-uppercase">Minha Conta </h5>
                          <h2 class="mb-3 font-18">25</h2>
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <img src="{{ asset('customer/img/banner/1.png') }}" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <img src="{{ asset('customer/img/banner/4.png') }}" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <table class="table table-striped">
                        ...
                        <td class="text-truncate">
                          <ul class="list-unstyled order-list m-b-0 m-b-0">
                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                src="{{ asset('customer/img/users/user-8.png') }}" alt="user" data-toggle="tooltip" title=""
                                data-original-title="Wildan Ahdian"></li>
                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                src="{{ asset('customer/img/users/user-9.png') }}" alt="user" data-toggle="tooltip" title=""
                                data-original-title="John Deo"></li>
                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                src="{{ asset('customer/img/users/user-10.png') }}" alt="user" data-toggle="tooltip" title=""
                      ...
                      <tr>
                        ...
                        <td class="text-truncate">
                          <ul class="list-unstyled order-list m-b-0 m-b-0">
                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                src="{{ asset('customer/img/users/user-1.png') }}" alt="user" data-toggle="tooltip" title=""
                                data-original-title="Wildan Ahdian"></li>
                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                src="{{ asset('customer/img/users/user-2.png') }}" alt="user" data-toggle="tooltip" title=""
                                data-original-title="John Deo"></li>
                      ...
                      <tr>
                        ...
                        <td class="text-truncate">
                          <ul class="list-unstyled order-list m-b-0 m-b-0">
                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                src="{{ asset('customer/img/users/user-3.png') }}" alt="user" data-toggle="tooltip" title=""
                                data-original-title="Wildan Ahdian"></li>
                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                src="{{ asset('customer/img/users/user-4.png') }}" alt="user" data-toggle="tooltip" title=""
                                data-original-title="John Deo"></li>
                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                src="{{ asset('customer/img/users/user-5.png') }}" alt="user" data-toggle="tooltip" title=""
                                data-original-title="Sarah Smith"></li>
                      ...
                      <tr>
                        ...
                        <td class="text-truncate">
                          <ul class="list-unstyled order-list m-b-0 m-b-0">
                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                src="{{ asset('customer/img/users/user-7.png') }}" alt="user" data-toggle="tooltip" title=""
                                data-original-title="John Deo"></li>
                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                src="{{ asset('customer/img/users/user-8.png') }}" alt="user" data-toggle="tooltip" title=""
                                data-original-title="Sarah Smith"></li>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="support-ticket media pb-1 mb-3">
                    <img src="{{ asset('customer/img/users/user-1.png') }}" class="user-img mr-2" alt="">
                  ...
                  <div class="support-ticket media pb-1 mb-3">
                    <img src="{{ asset('customer/img/users/user-2.png') }}" class="user-img mr-2" alt="">
                    <div class="media-body ml-3">
                  ...
                  <div class="support-ticket media pb-1 mb-3">
                    <img src="{{ asset('customer/img/users/user-3.png') }}" class="user-img mr-2" alt="">
                    <div class="media-body ml-3">
                  ...
                  <div class="support-ticket media pb-1 mb-3">
                    <img src="{{ asset('customer/img/users/user-6.png') }}" class="user-img mr-2" alt="">
                    <div class="media-body ml-3">
